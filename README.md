<div align="center">
  <a href="https://github.com/Jerry-XDL/AIDoctor">
    <img src="https://github.com/Jerry-XDL/AIDoctor/blob/main/docs/logo.png" width="120" alt="Logo">
  </a>
</div>
...
**AIDoctor** training medical GPT model with ChatGPT training pipeline, implemantation of Pretraining, Supervised Finetuning, Reward Modeling and Reinforcement Learning.

<img src="https://github.com/Jerry-XDL/AIDoctor/blob/main/docs/GPT_Training.jpg" width="860" />

Training AIDoctor model：
...
[Training Detail wiki](https://github.com/Jerry-XDL/AIDoctor/wiki/Training-Details)
...
Based on the limitations of the above models, we require developers to only use our open source model weights and subsequent derivatives generated by this project for research purposes, and not for commercial use, and other purposes that will cause harm to society. This project can only be used for research purposes, and the project developer is not responsible for any harm or loss caused by the use of this project (including but not limited to data, models, codes, etc.). For details, please refer to [Disclaimer](https://github.com/Jerry-XDL/AIDoctor/blob/main/DISCLAIMER). The license agreement for the project code is [The Apache License 2.0](/LICENSE), the code is free for commercial use, and the model weights and data can only be used for research purposes. Please attach AIDoctor's link and license agreement in the product description.

## 😇 Citation

If you used AIDoctor in your research, please cite as follows:

```latex
@misc{AIDoctor,
   title={AIDoctor: Training Medical GPT Model},
   author={Ming Xu},
   year={2023},
   howpublished={\url{https://github.com/Jerry-XDL/AIDoctor}},
}
```
